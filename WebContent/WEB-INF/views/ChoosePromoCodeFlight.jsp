...
<body>
	<form:form action="./Payment" modelAttribute="pickedPromoCode">


		<p>
			<b>Select a Promo Code</b>
			<form:select path="promotionName">
				<c:forEach var="element" items="${arrayListPromoFlight}">
					<form:option value="${element.promotionName}">${element.promotionName} </form:option>
				</c:forEach>
			</form:select>
			&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
